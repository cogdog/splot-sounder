...
<div class="credits section bg-dark small-padding">
	...
	<div class="credits-inner section-inner">
		...
		A <a href="http://splot.ca/">SPLOT</a> on the Web: <a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php bloginfo('name'); ?></a> | <?php _e('Blame','baskerville'); ?> <a href="http://cogdog.info">cogdog</a> 			
		...
		<p class="credits-right fright">
			...
			<span><?php printf( __( 'Base on Theme by <a href="%s">Anders Noren</a>', 'baskerville'), 'http://www.andersnoren.se' ); ?> &mdash; </span><a class="tothetop" title="<?php _e('To the top', 'baskerville'); ?>" href="#"><?php _e('Up', 'baskerville' ); ?> &uarr;</a>
